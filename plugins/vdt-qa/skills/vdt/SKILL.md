---
name: vdt
description: Jira 티켓 1건을 입력하면 가상 개발팀(기획/개발/아트/TA/QA)이 기획서를 분석해 리스크·AC 판정·팀 회의 시뮬레이션 보고서를 생성합니다. "/vdt", "vdt 실행", "가상 개발팀 분석", "CVS-XXXXX 가상팀" 요청 시 사용합니다.
---
...
> BagelPages는 사내망(VPN)에서만 접근 가능하다. 배포 즉시 링크가 활성화된다.
...
📄 *분석 보고서*: https://vdt-{ticket_key_lowercase}.pages.bagelgames.com
```
